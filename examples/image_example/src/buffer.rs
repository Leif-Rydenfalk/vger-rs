...
impl WgImageBuffer {
    ...
    pub fn to_host_image(
        ...
        // Corrected the chunks_exact_mut to use unpadded_bytes_per_row
        for (padded, flat_pixels_row) in padded_data
            .chunks_exact(padded_bytes_per_row)
            .zip(flat_pixels.chunks_exact_mut(unpadded_bytes_per_row))
        // Fix is here
        {
            flat_pixels_row
                .copy_from_slice(bytemuck::cast_slice(&padded[..unpadded_bytes_per_row]));
        }
